...
#ifndef FOUNDATION_ACE_ADAPTER_PREVIEW_INSPECTOR_INSPECT_SWIPER_H
#define FOUNDATION_ACE_ADAPTER_PREVIEW_INSPECTOR_INSPECT_SWIPER_H
...
#endif // FOUNDATION_ACE_ADAPTER_PREVIEW_INSPECTOR_INSPECT_SWIPER_H

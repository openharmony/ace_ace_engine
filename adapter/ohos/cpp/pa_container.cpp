...
{
    LOGE("PA: PaContainer::RunPa start");
    auto container = AceEngine::Get().GetContainer(instanceId);
    if (!container) {
...
sptr<IRemoteObject> PaContainer::OnConnect(int32_t instanceId, const std::string &want)
{
...
void PaContainer::OnDisConnect(int32_t instanceId, const std::string &want)
{

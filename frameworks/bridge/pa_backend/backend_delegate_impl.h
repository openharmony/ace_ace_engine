...
using ConnectCallback = std::function<sptr<IRemoteObject>(const std::string &want)>;
using DisConnectCallback = std::function<void(const std::string &want)>;
...
public:
    ...
    sptr<IRemoteObject> OnConnect(const std::string &want);
    void OnDisConnect(const std::string &want);

...
void JsiUtils::SetCurrentState(const std::shared_ptr<JsRuntime>& runtime, JsErrorType errorType, int32_t instanceId,
    const std::string& pageUrl, const RefPtr<JsAcePage>& page)
{
    runtime_ = runtime;

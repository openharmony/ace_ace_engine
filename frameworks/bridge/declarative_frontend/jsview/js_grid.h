...
public:
    ...
    static void SetColumnsTemplate(std::string value);
    static void SetRowsTemplate(std::string value);
    static void SetColumnsGap(const std::string& value);
    static void SetRowsGap(const std::string& value);
};

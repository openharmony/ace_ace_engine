...
void JSSpan::SetFontSize(const std::string& value)
{
...
void JSSpan::SetTextColor(const std::string& value)
{
    auto component = GetComponent();
    if (!component) {
        LOGE("component is not valid");
...
void JSSpan::SetFontFamily(const std::string& value)
{
    auto component = GetComponent();
    if (!component) {
        LOGE("component is not valid");
...
void JSSpan::SetLetterSpacing(const std::string& value)
{
    auto component = GetComponent();
    if (!component) {
        LOGE("component is not valid");
...
void JSSpan::Create(const std::string& label)
{

...
public:
    ...
    static void SetFontSize(const std::string& value);
    static void SetFontWeight(const std::string& value);
    static void SetTextColor(const std::string& value);
    ...
    static void SetLineHeight(const std::string& value);
    static void SetFontFamily(const std::string& fontFamily);
    static void SetMinFontSize(const std::string& value);
    static void SetMaxFontSize(const std::string& value);
    static void SetLetterSpacing(const std::string& value);
    static void SetTextCase(int32_t value);
    static void SetBaselineOffset(const std::string& value);

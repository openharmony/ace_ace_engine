...
void JSCalendar::Create(const JSCallbackInfo& info)
{
    ...
    calendarComponent->SetCalendarTheme(theme->GetCalendarTheme());
...
void JSCalendar::SetCurrentDayStyle(const JSCallbackInfo& info)
{
    ...
    auto obj = JSRef<JSObject>::Cast(info[0]);
    auto& theme = component->GetCalendarTheme();
    ...
    ConvertFromJSValue(obj->GetProperty("dayFontSize"), theme.dayFontSize);
    ConvertFromJSValue(obj->GetProperty("lunarDayFontSize"), theme.lunarDayFontSize);
...
void JSCalendar::SetWeekStyle(const JSCallbackInfo& info)
{
    ...
    ConvertFromJSValue(obj->GetProperty("weekFontSize"), theme.weekFontSize);

...
#ifdef USE_V8_ENGINE
    void JsHandlerOnGestureEvent(JSGestureEvent action, const v8::FunctionCallbackInfo<v8::Value>& args);
    void JsHandlerOnAction(const v8::FunctionCallbackInfo<v8::Value>& args);
    void JsHandlerOnActionStart(const v8::FunctionCallbackInfo<v8::Value>& args);
    void JsHandlerOnActionUpdate(const v8::FunctionCallbackInfo<v8::Value>& args);
    void JsHandlerOnActionEnd(const v8::FunctionCallbackInfo<v8::Value>& args);
    void JsHandlerOnActionCancel(const v8::FunctionCallbackInfo<v8::Value>& args);
#endif

...
static constexpr auto PANDA_STDLIB_PATH = "/system/framework/arkstdlib.abc";
...
bool ArkJSRuntime::Initialize(const std::string &libraryPath)
{
    ...
    const int64_t poolSize = 0x10000000;  // 256MB
    option.SetGcPoolSize(poolSize);
    option.SetPandaStdFile(PANDA_STDLIB_PATH);

...
public:
    JsiValue() = default;
    explicit JsiValue(panda::Local<panda::JSValueRef> rhs);
...
public:
    JsiArray();
    JsiArray(panda::Local<panda::ArrayRef> arr);
...
public:
    JsiObject();
    JsiObject(panda::Local<panda::ObjectRef>);
...
public:
    JsiFunction();
    JsiFunction(panda::Local<panda::FunctionRef> value);
...
class JsiObjTemplate : public JsiType<panda::JSValueRef> {
public:
    JsiObjTemplate() = default;
    JsiObjTemplate(panda::Local<panda::JSValueRef> obj);

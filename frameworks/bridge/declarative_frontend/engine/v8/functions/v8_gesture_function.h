...
class V8GestureFunction : public V8Function {
    DECLARE_ACE_TYPE(V8GestureFunction, V8Function)

public:
    explicit V8GestureFunction(v8::Local<v8::Function> jsFunction)
        : V8Function(v8::Undefined(v8::Isolate::GetCurrent()), jsFunction)
    {}

    ~V8GestureFunction()
    {
        LOGD("Destroy: V8GestureFunction");
    };
    void execute();

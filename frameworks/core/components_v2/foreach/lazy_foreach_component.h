...
public:
    ...
    virtual void RegiterDataChangeListener(const RefPtr<DataChangeListener>& listener) = 0;
    virtual void UnregiterDataChangeListener(const RefPtr<DataChangeListener>& listener) = 0;

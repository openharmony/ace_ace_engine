...
class ListElement : public RenderElement, public FocusGroup, public ListItemGenerator {
...
public:
    ...
    void RecycleListItem(size_t index, bool forceDelete) override;
...
private:
    ...
    std::vector<ComponentNode> components_;

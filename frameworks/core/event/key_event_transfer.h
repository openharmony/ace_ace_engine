...
#ifndef FOUNDATION_ACE_FRAMEWORKS_CORE_EVENT_KEY_EVENT_TRANSFER_H
#define FOUNDATION_ACE_FRAMEWORKS_CORE_EVENT_KEY_EVENT_TRANSFER_H
...
#endif // FOUNDATION_ACE_FRAMEWORKS_CORE_EVENT_KEY_EVENT_TRANSFER_H
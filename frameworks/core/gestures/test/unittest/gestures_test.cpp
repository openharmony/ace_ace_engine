...
HWTEST_F(GesturesTest, RotationRecognizer001, TestSize.Level1)
{
    ...
    rotationRecognizer->SetOnActionStart([&onRotation](const GestureEvent& info) {
        onRotation.SetRotationInfo(info); });
    rotationRecognizer->SetOnActionUpdate([&onRotation](const GestureEvent& info) {
        onRotation.SetRotationInfo(info); });
    rotationRecognizer->SetOnActionEnd([&onRotation](const GestureEvent& info) {
        onRotation.SetRotationInfo(info); });
...
HWTEST_F(GesturesTest, MultiLongPressRecognizer001, TestSize.Level1)
{
    ...
    longPressRecognizer->SetOnAction([&onLongPress](const GestureEvent& info) {
        onLongPress.SetMultiLongPressInfo(info); });
    longPressRecognizer->SetOnActionEnd([&onLongPress](const GestureEvent& info) {
        onLongPress.SetMultiLongPressInfo(info); });
    longPressRecognizer->SetOnActionCancel([&onLongPress]() {

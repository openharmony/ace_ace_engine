...
private:
    ...
    void SetPadding(const Dimension& value, const DimensionHelper& helper);
    Dimension GetPadding(const DimensionHelper& helper);
    void SetMargin(const Dimension& value, const DimensionHelper& helper);

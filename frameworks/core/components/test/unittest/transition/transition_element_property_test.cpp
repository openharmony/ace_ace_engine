...
public:
    ...
    void CreateAndBuildTransitionComponent()
    {
        ...
        context_ = AceType::MakeRefPtr<PipelineContext>(std::move(window),
            taskExecutor, assetManager, resRegister, frontend, 0);
        ...
        transitionComponent_ = AceType::MakeRefPtr<MockTransitionPropertyComponent>("test_transition_id",
            "transition component", boxComponent_);

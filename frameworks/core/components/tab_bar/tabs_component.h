...
public:
    TabsComponent(FlexDirection direction, FlexAlign mainAxisAlign, FlexAlign crossAxisAlign,
        std::list<RefPtr<Component>>& children, BarPosition barPosition = BarPosition::START);

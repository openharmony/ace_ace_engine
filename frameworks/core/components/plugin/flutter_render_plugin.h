...
#ifndef FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_PLUGIN_FLUTTER_RENDER_PLUGIN_H
...
class FlutterRenderPlugin : public RenderPlugin {
    DECLARE_ACE_TYPE(FlutterRenderPlugin, RenderPlugin);

public:
    FlutterRenderPlugin() = default;
    ~FlutterRenderPlugin() override = default;

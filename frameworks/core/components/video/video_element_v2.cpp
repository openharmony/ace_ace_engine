...
void VideoElementV2::UpdatVideoComponent(const RefPtr<VideoComponentV2>& videoComponent)
{
    if (videoComponent) {
        ...
        videoComponent_->SetPlayMode(videoComponent->GetPlayMode());
        videoComponent_->SetFullscreenMode(videoComponent->GetFullscreenMode());
        videoComponent_->SetCurrentTime(videoComponent->GetCurrentTime());
